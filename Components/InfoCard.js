...
function InfoCard({ img, location, desc, star, title, price, total }) {
    return (
        <div className="block ml-8 lg:flex py-7 px-2 border-b cursor-pointer rounded-lg hover:bg-gray-100 hover:scale-105 transform duration-300 ease-out transition hover:shadow-3xl">
